...
### ADJUSTABLE ###
module_length = 302  # mm
skin_thickness = 0.5  # mm
stringer_area = 56 # mm^2
n_stringers = 8

neutral_line_switch = 1
neutral_line_offset = np.sin(np.deg2rad(30)) * radius * neutral_line_switch

model_factor = 1.5
maximum_lift = 2.1*9.81*34/2  # N
maximum_drag = maximum_lift*0.315  # N
moment = maximum_lift * model_factor * module_length / 1000 / 4  # Nm
##################
...
# TODO: Change value and check direction
...
print(f"Skin SF: {240 / von_mises:.2f}. Aluminium 6061 T6")           # TODO: comment out for fin
...
# σ_bending_lift = maximum_lift * model_factor * module_length / 4 * stringer_r / stringer_I
# σ_bending_drag = maximum_drag * model_factor * module_length / 4 * stringer_r / stringer_I
...
σ_bending_lift = maximum_lift / 2 * model_factor * module_length / 4 * square_l / 2 / square_I
# σ_bending_drag = maximum_drag / 2 * model_factor * module_length / 4 * square_l / 2 / square_I
σ_bending_drag = (maximum_drag*0.2) * model_factor * square_l / 2 / square_I
